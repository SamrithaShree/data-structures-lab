//Program to perform the functions of Priority Queue ADT - max heap implementation
#include <stdio.h>
#define MAX 100  
...
// Delete the maximum element (root of heap)
...
// Sort the priority queue using Heap Sort
